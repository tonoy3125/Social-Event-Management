        ...
        <section className="bg-[#f2f2f4cc] ">
            <div className="container px-6 py-10 mx-auto">
                ...
                <div className="grid grid-cols-1 gap-8 mt-8 lg:mt-16 md:grid-cols-2 lg:grid-cols-4">
                    <div className=" cursor-pointer shadow-2xl shadow-slate-300 border rounded-xl bg-[#fff] ">
                        ...
                        <div className="flex items-center justify-center mt-20 mb-14">
                            <img className="object-cover w-10 h-10 rounded-full ring-4 ring-gray-300 mr-5" src={avatar1} alt="" />
                    ...
                    <div className=" cursor-pointer shadow-2xl shadow-slate-300 border rounded-xl bg-[#fff] ">
                        ...
                        <div className="flex items-center justify-center mt-20 mb-14">
                            <img className="object-cover w-10 h-10 rounded-full ring-4 ring-gray-300 mr-5" src={avatar2} alt="" />
                    ...
                    <div className=" cursor-pointer shadow-2xl shadow-slate-300 border rounded-xl bg-[#fff] ">
                        ...
                        <div className="flex items-center justify-center mt-20 mb-14">
                            <img className="object-cover w-10 h-10 rounded-full ring-4 ring-gray-300 mr-5" src={avatar3} alt="" />
                    ...
                    <div className=" cursor-pointer shadow-2xl shadow-slate-300 border rounded-xl bg-[#fff] ">
                        ...
                        <div className="flex items-center justify-center mt-20 mb-14">
                            <img className="object-cover w-10 h-10 rounded-full ring-4 ring-gray-300 mr-5" src={avatar4} alt="" />
                            <h1 className=" text-xl font-semibold text-[#a3a3a6] capitalize mr-1">Jessica Mann</h1>
                            <MdVerified className="text-xl text-blue-700"></MdVerified>
                        </div>
                    </div>
